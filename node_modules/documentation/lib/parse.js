...
var flatteners = {
   ...
   */
  access: function access(result, tag) {
   ...
   * @returns {undefined} has side-effects
   */
  augments: function augments(result, tag) {
   ...
   * @returns {undefined} has side-effects
   */
  callback: function callback(result, tag) {
    result.kind = 'typedef';
  ...
  deprecated: function deprecated(result, tag) {
    var description = tag.description || 'This is deprecated.';
    result.deprecated = parseMarkdown(description);
  },

  flattenMarkdownDescription: flattenMarkdownDescription,
   ...
   * @returns {undefined} has side-effects
   */
  event: function event(result, tag) {
    result.kind = 'event';
   ...
   * @returns {undefined} has side-effects
   */
  example: function example(result, tag) {
    if (!tag.description) {
      result.errors.push({
   ...
   * @returns {undefined} has side-effects
   */
  external: function external(result, tag) {
   ...
   * @returns {undefined} has side-effects
   */
  instance: function instance(result) {
   ...
   * @returns {undefined} has side-effects
   */
  interface: function _interface(result, tag) {
   ...
   * @returns {undefined} has side-effects
   */
  param: function param(result, tag) {
    var param = {
      title: 'param',
      name: tag.name,
   ...
   * @returns {undefined} has side-effects
   */
  private: function _private(result) {
   ...
   * @returns {undefined} has side-effects
   */
  property: function property(result, tag) {
    var property = {
      title: 'property',
      name: tag.name,
      lineNumber: tag.lineNumber // TODO: remove
   ...
   * @returns {undefined} has side-effects
   */
  protected: function _protected(result) {
   ...
   * @returns {undefined} has side-effects
   */
  public: function _public(result) {
   ...
   * @returns {undefined} has side-effects
   */
  returns: function returns(result, tag) {
    var returns = {
   ...
   * @returns {undefined} has side-effects
   */
  static: function _static(result) {
    result.scope = 'static';
  },
   ...
   * @returns {undefined} has side-effects
   */
  throws: function throws(result, tag) {
    var throws = {};
   ...
   * @returns {undefined} has side-effects
   */
  variation: function variation(result, tag) {
