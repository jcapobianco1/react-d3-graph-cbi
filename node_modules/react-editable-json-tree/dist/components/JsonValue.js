...
var JsonValue = function (_Component) {
    (0, _inherits3.default)(JsonValue, _Component);

    function JsonValue(props) {
        (0, _classCallCheck3.default)(this, JsonValue);

        var _this = (0, _possibleConstructorReturn3.default)(this, (JsonValue.__proto__ || (0, _getPrototypeOf2.default)(JsonValue)).call(this, props));
    ...
    (0, _createClass3.default)(JsonValue, [{
        ...
        value: function render() {
            ...
            var _props3 = this.props,
                ...
                inputElement = _props3.inputElement,
            ...
            if (editEnabled && !readOnlyResult) {
                ...
                var inputElementLayout = _react2.default.cloneElement(inputElement, {
                    ref: this.refInput,
                ...
                result = _react2.default.createElement(
                    'span',
                    { className: 'rejt-value', style: style.value, onClick: readOnlyResult ? null : this.handleEditMode },
                    value
                );
                /* eslint-enable */
            ...
            return _react2.default.createElement(
                ...
                { className: 'rejt-value-node', component: 'li', style: style.li, handlers: handlers },
